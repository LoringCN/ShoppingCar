...
import cn.huace.filter.DeviceSessionFilter;
...
//        servletRegistrationBean.addInitParameter("deny","192.168.1.73");
    ...
    @Bean
    public FilterRegistrationBean deviceSessionFilterRegistration() {
        FilterRegistrationBean registration = new FilterRegistrationBean(new DeviceSessionFilter());
